...
<div class="main-container">
    ...
    <table class="table table-striped table-hover align-middle text-center" id="fileTable">
        <thead class="table-primary">
            <tr>
                <th scope="col">#</th>
                <th hidden scope="col">Id</th>
                <th scope="col"><i class="bi bi-file-earmark-text"></i> File Title</th>
            ...
            <c:if test="${not empty materials}">
                <c:forEach var="material" items="${materials}" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a href="${material.description}" target="_blank">
...
<div class="modal fade" id="pdfModal" tabindex="-1" aria-labelledby="pdfModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <!-- Close button styling: Making it visible and bigger -->
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="font-size: 1 rem; padding: 0.5rem;">x</button>
            </div>
            <div class="modal-body">
                <!-- Making iframe bigger for better PDF view -->
 ...
 function openMaterialModal(mode, material = {}) {
	    ...
	    if (mode === 'add') {
	        ...
	        downloadButton.href = `${pageContext.request.contextPath}/uploads/` + material.uploadUrl;
	    }
