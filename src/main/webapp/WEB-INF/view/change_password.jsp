...
<html>
  ...
  <div class="col-sm-5 col-md-5 position-relative">
    <input
      type="password"
      name="pass"
      id="pass"
    ...
    <i class="bi bi-eye-slash toggle-password"
       data-target="pass"
       style="position: absolute; top: 35%; right: 30px; transform: translateY(-50%); cursor: pointer;"></i>

    <small id="passwordLengthMsg" class="form-text text-muted">
      You must enter 8 characters.
    </small>
  </div>
</div>
