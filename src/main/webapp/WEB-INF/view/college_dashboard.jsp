									...
									<div class="row">
										<div class="col-md-9">
											<h6 class="h5 mb-2" data-toggle="tooltip"
												...
												${companyDrive}
												<c:choose>
													<c:when test="${fn:length(comp_add.description) > 60}">
														<span> ${fn:substring(comp_add.description, 0, 57)}...
															<a data-toggle="collapse"
															href="#moreDesc${comp_add.companyId}" role="button"
															aria-expanded="false"
															aria-controls="moreDesc${comp_add.companyId}"> <strong>Read
																	more</strong>
														</a>
														</span>
													</c:when>
											...
											<c:if test="${fn:length(comp_add.description) > 60}">
