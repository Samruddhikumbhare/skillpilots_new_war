...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.bundle.min.js"></script>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
    <a href="company_internships?tab=pending" style="text-decoration: none;">
  ...
  <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
    <a href="company_internships?tab=ongoingTab" style="text-decoration: none;">
  ...
  <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
    <a href="company_internships?tab=completed" style="text-decoration: none;">
      <div class="card-box min-height-200px pd-20" data-bgcolor="#455a64" style="background-color: rgb(69, 90, 100)">
        <div class="d-flex justify-content-between pb-20 text-white">
          <div class="icon h1 text-white">
  ...
  <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
    <a href="company_internships?tab=requests" style="text-decoration: none;">
      <div class="card-box min-height-200px pd-20" data-bgcolor="#265ED7" style="background-color: rgb(38, 94, 215)">
        <div class="d-flex justify-content-between pb-20 text-white">
          <div class="icon h1 text-white">
            <i class="icon-copy fa fa-certificate" aria-hidden="true"></i>
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (tab) {
      ...
      if (tabLink) {
        tabLink.click(); // Trigger tab switch
      }
    }
  });
</script>
